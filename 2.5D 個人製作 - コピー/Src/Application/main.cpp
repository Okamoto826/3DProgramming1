...
bool Application::Init(int w, int h)
{
	...
	// ウィンドウ作成
	//===================================================================
	if (m_window.Create(w, h, "ヒューマン大戦争", "Window") == false) {
...
//				"終了確認", MB_YESNO | MB_ICONQUESTION | MB_DEFBUTTON2) == IDYES)
		...
		//
		//=========================================
		std::string titleBar = "FANTASY WAR | FPS:" + std::to_string(m_fpsController.m_nowfps);
...
void Application::ImGuiProcess()
{
	...
	if (ImGui::Begin("Debug Window"))
	{
		...
		ImGui::Text((const char*)u8"日本語表示テキスト");
