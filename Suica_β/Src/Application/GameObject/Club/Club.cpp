...
void Club::Update()
{
	...
	if (spTarget)
	{
		...
		m_coolTime = EventManager::Instance().GetClubCoolTime();
	}
	...
	if (m_nowSit == NowSit::LAtack)
	{
		...
		//if (EventManager::Instance().GetPlayerMoveFlg() == false)
		//{
		//	ResetPos();
		//}
	}
	...
	EventManager::Instance().SetRestTime(m_coolTime);
	...
	m_mWorld =XRotMat * YRotMat * TransMat * targetMat;
